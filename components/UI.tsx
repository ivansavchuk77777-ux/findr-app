...
export function Button({children,onPress,secondary=false}:{children:ReactNode,onPress?:()=>void,secondary?:boolean}){return <TouchableOpacity onPress={onPress} style={[s.btn,secondary&&s.secondary]}><Text style={s.btnText}>{children}</Text></TouchableOpacity>}
